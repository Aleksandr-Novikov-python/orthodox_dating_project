...
# ==============================================================================
# 6. FRONTEND ERROR HANDLING (JavaScript)
# ==============================================================================

"""
// Add to your base template or static JS file
...
// Example: Send like with error handling
function sendLike(profileId) {
    $.ajax({
        ...
        success: function(response) {
            if (response.success) {
                showNotification(
                    response.mutual ? '🎉 Взаимная симпатия!' : 'Симпатия отправлена',
                    'success'
                );
            }
        },
        error: function(xhr) {
            const msg = xhr.responseJSON?.error || 'Не удалось отправить симпатию';
...
# ==============================================================================
# 7. ERROR TEMPLATE (templates/profiles/error.html)
# ==============================================================================
    ...
    <div class="row justify-content-center">
        <div class="col-md-6 text-center">
            {% if error_type == 'user_error' %}
                ...
                <h2 class="mt-3">Внимание</h2>
            {% else %}
                <i class="bi bi-x-circle fs-1 text-danger"></i>
                <h2 class="mt-3">Произошла ошибка</h2>
            {% endif %}
            
            <p class="lead mt-3">{{ error_message }}</p>
            
            <div class="mt-4">
                <a href="{% url 'profiles:home' %}" class="btn btn-custom">
...
MIDDLEWARE = [
    # ... other middleware
    'profiles.middleware.ErrorHandlerMiddleware',
]
